...
int NetSendMessage(int transport, void * connection, long clientIndex, int msgClass, int msgId, int msgSize, void * payload);
int NetSendAppMessage(int transport, void * connection, long clientIndex, int msgId, int msgSize, void * payload);
...
int netSendMediusAppMessage(int transport, void * connection, int clientIndex, int msgClass, int msgId, int msgSize, void * payload)
{
    if (!connection)
        return 0;
    return NetSendMessage(transport, connection, clientIndex, msgClass, msgId, msgSize, payload);
}
...
int netBroadcastMediusAppMessage(int transport, void * connection, int msgId, int msgSize, void * payload)
{
    if (!connection)
        return 0;
    return NetSendAppMessage(transport, connection, -1, msgId, msgSize, payload);
}
